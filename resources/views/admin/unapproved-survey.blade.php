...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-10">
            <div class="card"  >
                <div class="card-header" style="background: #31353d;text-align: center;color: white;"><h2>Un-Approved Surveys</h2></div>
                ...
                <div class="card-body">
                    ...
                    @endif
                     ...
                     <p><b>Name: </b> {{$surveys->name}} </p>
                      ...
                      <small style="float: right;">Un-Approved By <b style="font-size: 15px">{{$surveys->name}}</b> Posted on {{$surveys->created_at}}</small>
